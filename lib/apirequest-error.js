...
Errors.InvalidArgumentError = function(contextName, argumentName, errorName) {
    this.message = 'The '+ argumentName +' argument is invalid for the `'+ contextName +'` function: '+ errorName;
};
